                ...
                <form action="?page=trainingbukutambahpro" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Judul</label>
                                <textarea class="form-control" placeholder="isikan judul buku ..." name="judul" autocomplete="OFF" required></textarea>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Abstrak</label>
                                <textarea class="form-control" placeholder="isikan abstrak buku ..." name="abstrak" autocomplete="OFF" rows="5" required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <?php 
                                    ...
                                    while($datas = mysqli_fetch_array($sql)){
                                        echo '<option value="'.$datas['id_kategori'].'">'.$datas['nama_kategori'].'</option>';
                                    }
                                ?>
                                </select>
                            </div>
